#!/usr/bin/env bash
# You can use this script to download nvm (Node Version Manager),
# which  is an open source version manager for Node.js (Node).
# NVM is easy to understand and works on any POSIX-compliant shell (e.g. sh or bash).
# NVM allows you to easily install and manage different versions of Node and switch between them on a per-shell basis.
...
nvm_source() {
  ...
  if [ "_$NVM_METHOD" = "_script-nvm-exec" ]; then
    ...
    if [ "_$NVM_METHOD" = "_script" ]; then
      ...
      NVM_SOURCE_URL="https://gitee.com/arkmon/nvm.git"
    else
